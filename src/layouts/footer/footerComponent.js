...
class FooterComponent extends HTMLElement {
  constructor() {
    ...
    linkElem.setAttribute('href', './footer.scss');
        ...
        <section class="footer__container">
          ...
          <div class="footer__inner">
            <section class="footer__inner-top">
              ...
              <article class="footer__notice paragraph-large label-small">
                <h3>공지사항</h3>
                <p>[안내]&nbsp;&nbsp;합병보고 주주총회에 갈음하는 공고</p>
              </article>
              <ul class="footer__buttons paragraph-large label-small">
                <li>브랜드 바로가기 &nbsp;&nbsp;&#43;</li>
                <span aria-hidden="true">|</span>
                <li>그룹 계열사 바로가기 &nbsp;&nbsp;&#43;</li>
              </ul>
            </section>
            <ul class="footer__service paragraph-large label-small">
            ...
            <section class="footer__company-info">
              <address class="paragraph-large label-small">
                <p>
            ...
            <small class="paragraph-large label-small">Copyright &#64; 주식회사 티빙 All right reserved.</small>
          </div>
        </section>
      </footer>
    `;
